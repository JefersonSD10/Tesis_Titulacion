...
& \multirow{3}{=}{Polarización editorial}
& ISN por fuente
...
\subsubsection*{Cómputo de los indicadores de polarización editorial (ICMC e IDN)}

Además de las métricas de desempeño descritas, el sistema computa dos indicadores
orientados a cuantificar la \textbf{polarización editorial} —el tratamiento
...
$ICMC > 25$ se interpreta como indicio de polarización editorial: el candidato recibe
