...
Los ecosistemas digitales han transformado significativamente la forma en que se desarrolla la comunicación política durante los procesos electorales. Plataformas como periódicos digitales, X/Twitter, YouTube y TikTok generan continuamente grandes volúmenes de información relacionados con candidatos, partidos políticos y acontecimientos coyunturales. Sin embargo, muchos enfoques tradicionales de análisis electoral presentan limitaciones al centrarse únicamente en encuestas o en una sola fuente de datos, dificultando la comprensión integral de la percepción proyectada por los medios de comunicación en entornos digitales.
...
La investigación aborda como problema específico la polarización de la percepción mediática digital —el tratamiento sistemáticamente opuesto de un mismo candidato entre las distintas fuentes y plataformas digitales que consume el electorado—, cuantificada mediante el Índice de Cobertura Mediática Comparada (ICMC), que mide su magnitud agregada entre fuentes, y el Índice de Divergencia Narrativa (IDN), que identifica los pares de fuentes con tratamiento opuesto. Así, contribuye con una propuesta metodológica y tecnológica orientada al análisis automatizado del comportamiento mediático electoral en contextos digitales, proporcionando un prototipo capaz de apoyar procesos de monitoreo político y análisis estratégico basados en inteligencia artificial.

\textbf{Palabras clave:} inteligencia electoral, polarización de la percepción mediática digital, ICMC, IDN, modelos de lenguaje de gran escala, minería de sentimientos, detección dinámica de temas, grafos de conocimiento, GraphRAG, análisis multi-fuente.
\clearpage
...
\textbf{Keywords: } electoral intelligence, digital media-perception polarization, ICMC, IDN, large language models (LLMs), sentiment mining, topic detection, knowledge graphs, GraphRAG, multi-source analysis, media-projected perception.