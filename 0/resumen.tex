...
La investigación aborda como problema específico la polarización editorial —el tratamiento sistemáticamente opuesto de un mismo candidato entre las distintas fuentes y plataformas digitales que consume el electorado—, cuantificada mediante el Índice de Cobertura Mediática Comparada (ICMC), que mide su magnitud agregada entre fuentes, y el Índice de Divergencia Narrativa (IDN), que identifica los pares de fuentes con tratamiento opuesto. Así, contribuye con una propuesta metodológica y tecnológica orientada al análisis automatizado del comportamiento mediático electoral en contextos digitales, proporcionando un prototipo capaz de apoyar procesos de monitoreo político y análisis estratégico basados en inteligencia artificial.

\textbf{Palabras clave:} inteligencia electoral, polarización editorial, ICMC, IDN, modelos de lenguaje de gran escala, minería de sentimientos, detección dinámica de temas, grafos de conocimiento, GraphRAG, análisis multi-fuente.
\clearpage
...
\textbf{Keywords: } electoral intelligence, editorial polarization, ICMC, IDN, large language models (LLMs), sentiment mining, topic detection, knowledge graphs, GraphRAG, multi-source analysis, media-projected perception.