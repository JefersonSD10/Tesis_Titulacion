...
%% Metadatos del PDF (pdftitle/pdfauthor/...) configurados en las opciones
%% de \usepackage{hyperref} mas abajo.
...
urlcolor=black,
bookmarks=true,
linktoc=all,% hace clicable toda la linea del indice (texto + numero de pagina)
linkcolor=black,
pdftitle={Sistema de Inteligencia Electoral basado en LLMs y Grafos de Conocimiento para el Análisis Multi-fuente del Discurso Mediático Digital: Caso Elecciones Presidenciales Perú 2026},
pdfauthor={Axel Denis Cuadros Huachua, Victor Manuel Ormeño Salazar, Piero Luis Rojas Paucar, Jeferson Joseph Sandoval Díaz},
pdfsubject={Tesis de grado — Ingeniería de Tecnologías de Información y Sistemas, Universidad ESAN},
pdfkeywords={inteligencia electoral, LLMs, grafos de conocimiento, GraphRAG, análisis multi-fuente}]{hyperref}
...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Sistema de Inteligencia Electoral basado en LLMs y Grafos de Conocimiento para el Análisis Multi-fuente del Discurso Mediático Digital: Caso Elecciones Presidenciales Perú 2026}
	\fancyhead[R]{\thepage}}
...
% Encabezado de bibliografia con \phantomsection para que el enlace del
% indice apunte al lugar correcto. El bibintoc por defecto de biblatex omite
% \phantomsection y, combinado con titlesec, el enlace del TOC queda desfasado.
