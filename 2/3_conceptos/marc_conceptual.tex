...
El \textbf{Índice de Cobertura Mediática Comparada} (ICMC) cuantifica la magnitud de la polarización editorial sobre una misma entidad política, midiendo la dispersión del ISN entre las distintas fuentes que la cubren. Se calcula como la desviación estándar del ISN por fuente respecto a su media, mediante la Ecuación \ref{eq:icmc}:
...
Un ICMC elevado indica que las fuentes tratan a la entidad de forma marcadamente distinta —síntoma de polarización editorial—, mientras que un valor cercano a cero refleja consenso narrativo entre medios.
...
Mientras el ICMC resume la magnitud agregada de la divergencia entre todas las fuentes, el IDN localiza los pares con visiones contrapuestas, evidenciando la estructura de la polarización editorial (por ejemplo, prensa tradicional frente a plataformas de video corto).

El \textbf{Índice de Relevancia Temática} (IRT) mide la importancia relativa de un tema en el corpus en un período dado, calculado como la proporción de documentos asignados a ese tema sobre el total del corpus en ese período. El \textbf{Índice de Velocidad de Emergencia} (IVE) mide la rapidez con la que un tema nuevo gana relevancia en el discurso mediático, calculado como la derivada temporal del IRT. Estos cinco indicadores se articulan en torno a la polarización editorial: el ISN desagregado por fuente constituye el insumo común a partir del cual el ICMC y el IDN la operacionalizan —el primero cuantifica su magnitud agregada y el segundo su estructura par a par—, mientras que el IRT y el IVE cumplen un rol complementario al caracterizar la agenda temática en la que se inscribe esa cobertura. Monitoreados conjuntamente en tiempo real y representados estructuralmente en el grafo de conocimiento electoral, constituyen el núcleo analítico del sistema de inteligencia electoral propuesto para el caso de las Elecciones Presidenciales Perú 2026.