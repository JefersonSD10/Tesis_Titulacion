...
pdfauthor={Axel Denis Cuadros Huachua, Victor Manuel Ormeño Salazar, Piero Luis Rojas Paucar, Jeferson Joseph Sandoval Díaz}]{hyperref}
...
\fancypagestyle{special}{%
	...
	\fancyhead[R]{\thepage}}
%%Encabezado para paginas en orientacion horizontal (landscape): solo numero
%%de pagina; el titulo largo queda oculto porque no entra correctamente al
%%rotar la pagina.
\fancypagestyle{horizontal}{%
	\fancyhf{}%
	\fancyfoot[R]{\thepage}%
	\renewcommand{\headrulewidth}{0pt}%
