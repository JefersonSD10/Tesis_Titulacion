...
HG: \newcommand{\HipotesisGeneral}{
 El uso integrado de modelos de lenguaje de gran escala (LLMs) y grafos de conocimiento permite construir un sistema de inteligencia electoral capaz de realizar análisis contextual, estructural y relacional del discurso mediático digital con calidad verificable mediante umbrales cuantitativos contrastados contra \textit{ground truth} humano y evaluaciones LLM-as-judge sobre conjuntos de referencia anotados, alcanzando simultáneamente F1 macro $\geq 0.80$ en clasificación de sentimiento dirigido, MAE $\leq 0.15$ en sentimiento continuo, exactitud semántica $\geq 0.70$ en la detección de tópicos y métricas de calidad de respuesta (\textit{correctness} y \textit{faithfulness}) $\geq 0.70$ en el componente GraphRAG.
}
\HipotesisGeneral
