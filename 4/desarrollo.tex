...
\begin{table}[h!]
    ...
    \centering
    \scriptsize
    \begin{longtable}{ m{0.5cm}m{3.6cm}M{1.2cm}M{1.1cm}M{1.2cm}M{1.3cm}M{1.4cm}M{1.2cm} }
        \specialrule{.1em}{.05em}{.05em}
        \Centering{\#} & \Centering{Candidato} & \Centering{Menc.} & \Centering{Temas} & \Centering{Medios} & \Centering{Ratio M/T} & \Centering{Sent.} & \Centering{ICMC} \\
        \specialrule{.1em}{.05em}{.05em}
        \endfirsthead
        \specialrule{.1em}{.05em}{.05em}
        \Centering{\#} & \Centering{Candidato} & \Centering{Menc.} & \Centering{Temas} & \Centering{Medios} & \Centering{Ratio M/T} & \Centering{Sent.} & \Centering{ICMC} \\
        \specialrule{.1em}{.05em}{.05em}
        \endhead
        1  & Keiko Fujimori         & 1\,262 & 353 & 7 & 3.58 & $-0.193$ & 26.01 \\
        2  & Rafael López Aliaga    & 1\,025 & 321 & 7 & 3.19 & $-0.219$ & 19.39 \\
        3  & César Acuña            & 829 & 290 & 7 & 2.86 & $-0.335$ & — \\
        4  & Carlos Álvarez         & 515 & 168 & 7 & 3.07 & $+0.062$ & 17.88 \\
        5  & Alfonso López Chau     & 479 & 179 & 7 & 2.68 & $-0.162$ & 22.87 \\
        6  & Jorge Nieto Montesinos & 455 & 156 & 7 & 2.92 & $-0.046$ & 19.81 \\
        7  & Vladimir Cerrón        & 448 & 178 & 7 & 2.52 & $-0.406$ & — \\
        8  & Roberto Sánchez        & 369 & 159 & 7 & 2.32 & $-0.207$ & 27.79 \\
        9  & Fernando Olivera       & 349 & 97  & 7 & 3.60 & $-0.206$ & 17.14 \\
        10 & Marisol Pérez Tello    & 339 & 127 & 7 & 2.67 & $+0.106$ & 20.05 \\
        11 & José Luna Gálvez       & 317 & 151 & 7 & 2.10 & $-0.157$ & 33.87 \\
        ...
        16 & Yonhy Lescano          & 220 & 88  & 7 & 2.50 & $-0.083$ & 26.84 \\
        17 & José Williams Zapata   & 206 & 91  & 7 & 2.26 & $+0.092$ & 18.94 \\
        18 & George Forsyth         & 202 & 86  & 7 & 2.35 & $+0.111$ & — \\
        19 & Fiorella Molinelli     & 198 & 83  & 7 & 2.39 & $+0.059$ & — \\
        20 & Álvaro Paz de la Barra & 196 & 63  & 6 & 3.11 & $-0.054$ & 24.91 \\
        21 & Ronald Atencio         & 188 & 97  & 7 & 1.94 & $-0.077$ & 18.68 \\
        22 & Carlos Espá            & 168 & 76  & 7 & 2.21 & $+0.085$ & 22.96 \\
        23 & Rafael Belaúnde        & 142 & 81  & 6 & 1.75 & $+0.203$ & — \\
        24 & Roberto Chiabra        & 137 & 70  & 7 & 1.96 & $+0.154$ & 18.80 \\
        25 & Ricardo Belmont        & 133 & 59  & 6 & 2.25 & $+0.122$ & 23.33 \\
        26 & Alex Gonzáles          & 115 & 43  & 6 & 2.67 & $-0.001$ & 28.59 \\
        27 & Martín Vizcarra        & 115 & 65  & 7 & 1.77 & $-0.207$ & 20.67 \\
        ...
        32 & Walter Chirinos        & 101 & 45  & 6 & 2.24 & $+0.045$ & 22.07 \\
        33 & Carlos Jaico           & 101 & 46  & 6 & 2.20 & $+0.239$ & — \\
        34 & Daniel Urresti         & 92  & 39  & 6 & 2.36 & $-0.135$ & 20.69 \\
    ...
    \begin{flushleft}
        \small Fuente: Elaboración propia, consulta al grafo de conocimiento.
        \enquote{—} indica candidato fuera del top-20 de divergencia editorial (ICMC).
    \end{flushleft}
\end{table}
...
\subsection*{Contraste y Validación de la Hipótesis Específica 3 (HE3): Polarización de la Percepción Mediática Digital}
La Hipótesis Específica 3 (HE3) sostiene que el grafo de conocimiento electoral permite cuantificar, en una única consulta estructural, la polarización de la percepción mediática digital sobre un mismo candidato entre fuentes, declarando dos umbrales verificables: un Índice de Cobertura Mediática Comparada $\text{ICMC} > 25$ (magnitud agregada de la divergencia) y un Índice de Divergencia Narrativa $\text{IDN} > 50$ sobre una escala de $0$ a $200$ (estructura par a par del tratamiento opuesto). Ambos índices se derivan del Índice de Sentimiento Neto (ISN) desagregado por fuente, materializado en la vista \texttt{gold\_sentimiento\_fuente\_diario}, que registra el sentimiento agregado hacia cada candidato en cada fuente. Conviene precisar que estos indicadores miden el \textbf{contenido} mediático publicado —el posicionamiento valorativo agregado de cada fuente o plataforma—, y no la recepción o el efecto en la audiencia ni una intención editorial deliberada.

El ICMC se calcula como la desviación estándar del ISN entre las fuentes que cubren a un mismo candidato: valores altos indican que los medios lo tratan de forma marcadamente distinta entre sí. La Tabla \ref{5:table_icmc} reporta los 20 candidatos con mayor divergencia editorial. Cinco superan el umbral de polarización de la percepción mediática digital significativa ($\text{ICMC} > 25$): José Luna Gálvez (33.87), Alex Gonzáles (28.59), Roberto Sánchez (27.79), Yonhy Lescano (26.84) y Keiko Fujimori (26.01). Destaca el caso de Keiko Fujimori, que alcanza alta divergencia pese a aparecer en las siete fuentes, lo que descarta que el ICMC elevado sea un mero artefacto de baja cobertura.

\begin{table}[h!]
    \caption[Índice de Cobertura Mediática Comparada (ICMC) por candidato]{Índice de Cobertura Mediática Comparada (ICMC) —desviación estándar del ISN entre fuentes— de los 20 candidatos con mayor divergencia editorial. En negrita, los cinco candidatos que superan el umbral $\text{ICMC} > 25$ de polarización de la percepción mediática digital significativa.}
    \label{5:table_icmc}
    \centering
    \scriptsize
    \begin{tabular}{ m{5.5cm}M{2.2cm}M{2.2cm} }
        \specialrule{.1em}{.05em}{.05em}
        \Centering{Candidato} & \Centering{N.\textsuperscript{o} de fuentes} & \Centering{ICMC} \\
        \specialrule{.1em}{.05em}{.05em}
        José Luna Gálvez       & 5 & \textbf{33.87} \\
        Alex Gonzáles          & 3 & \textbf{28.59} \\
        Roberto Sánchez        & 5 & \textbf{27.79} \\
        Yonhy Lescano          & 3 & \textbf{26.84} \\
        Keiko Fujimori         & 7 & \textbf{26.01} \\
        \specialrule{.05em}{.03em}{.03em}
        Álvaro Paz de la Barra & 3 & 24.91 \\
        Ricardo Belmont        & 3 & 23.33 \\
        Carlos Espá            & 3 & 22.96 \\
        Alfonso López Chau     & 5 & 22.87 \\
        Walter Chirinos        & 3 & 22.07 \\
        Daniel Urresti         & 3 & 20.69 \\
        Martín Vizcarra        & 4 & 20.67 \\
        Marisol Pérez Tello    & 5 & 20.05 \\
        Jorge Nieto Montesinos & 5 & 19.81 \\
        Rafael López Aliaga    & 6 & 19.39 \\
        José Williams Zapata   & 4 & 18.94 \\
        Roberto Chiabra        & 3 & 18.80 \\
        Ronald Atencio         & 4 & 18.68 \\
        Carlos Álvarez         & 6 & 17.88 \\
        Fernando Olivera       & 3 & 17.14 \\
        \specialrule{.1em}{.05em}{.05em}
    \end{tabular}
    \begin{flushleft}
        \small Fuente: Elaboración propia. La línea intermedia separa a los cinco candidatos con $\text{ICMC} > 25$.
    \end{flushleft}
\end{table}

El ICMC y el IDN se construyen sobre el ISN desagregado por fuente, que constituye su insumo directo. La Tabla \ref{5:table_isn_fuente} reconstruye dicho insumo para los candidatos involucrados en los pares de mayor divergencia, expresado en la escala $[-100, +100]$ (cobertura íntegramente crítica a íntegramente favorable). La lectura por filas evidencia el contraste de tratamiento: José Luna Gálvez pasa de $-71.4$ en Diario Correo a $+26.8$ en TikTok, y un patrón análogo se repite en Roberto Sánchez, Alfonso López Chau y Carlos Espá.

\begin{table}[h!]
    \caption[ISN desagregado por fuente para los candidatos más polarizados]{Índice de Sentimiento Neto (ISN, escala $[-100, +100]$) desagregado por fuente para los candidatos con mayor polarización de la percepción mediática digital. Insumo directo del ICMC y del IDN.}
    \label{5:table_isn_fuente}
    \centering
    \scriptsize
    \begin{tabular}{ m{2.6cm}M{1.4cm}M{1.4cm}M{1.4cm}M{1.4cm}M{1.4cm}M{1.4cm} }
        \specialrule{.1em}{.05em}{.05em}
        \Centering{Candidato} & \Centering{Diario Correo} & \Centering{El Comercio} & \Centering{RPP} & \Centering{Twitter/X} & \Centering{YouTube} & \Centering{TikTok} \\
        \specialrule{.1em}{.05em}{.05em}
        José Luna Gálvez    & $-71.4$ & — & $-52.2$ & $-12.2$ & $-31.4$ & $+26.8$ \\
        Roberto Sánchez     & $-65.2$ & — & — & — & — & $+2.9$ \\
        Alfonso López Chau  & $-45.9$ & — & — & $-39.7$ & — & $+19.0$ \\
        Yonhy Lescano       & — & — & — & $-35.9$ & $-26.9$ & $+25.0$ \\
        Keiko Fujimori      & $-47.8$ & $+8.7$ & $-34.5$ & $-45.0$ & — & — \\
        Rafael López Aliaga & $-60.9$ & — & — & $-50.0$ & $-19.4$ & $-6.5$ \\
        Carlos Espá         & — & — & — & $+2.0$ & — & $+57.7$ \\
        Roberto Chiabra     & — & — & — & — & $+21.7$ & $+66.7$ \\
        \specialrule{.1em}{.05em}{.05em}
    \end{tabular}
    \begin{flushleft}
        \small Fuente: Elaboración propia. Valores reconstruidos a partir de los pares reportados (Tabla \ref{5:table_idn}); las celdas vacías (\enquote{—}) corresponden a pares no incluidos en el top-20.
    \end{flushleft}
\end{table}

A partir de este insumo, el IDN mide la diferencia absoluta de ISN entre dos fuentes específicas sobre un mismo candidato; es la versión par a par del ICMC. La Tabla \ref{5:table_idn} presenta los 20 pares de mayor divergencia.

\begin{table}[h!]
    \caption[Índice de Divergencia Narrativa (IDN): pares de fuentes con tratamiento opuesto]{Índice de Divergencia Narrativa (IDN $= |\text{ISN}_{f_1} - \text{ISN}_{f_2}|$): los 20 pares de fuentes con tratamiento más opuesto sobre un mismo candidato. La línea separa los 14 pares que superan el umbral $\text{IDN} > 50$.}
    \label{5:table_idn}
    \centering
    \scriptsize
    \begin{tabular}{ m{2.6cm}m{1.9cm}m{1.9cm}M{1.1cm}M{1.1cm}M{1.0cm} }
        \specialrule{.1em}{.05em}{.05em}
        \Centering{Candidato} & \Centering{Fuente 1} & \Centering{Fuente 2} & \Centering{ISN $f_1$} & \Centering{ISN $f_2$} & \Centering{IDN} \\
        \specialrule{.1em}{.05em}{.05em}
        José Luna Gálvez       & Diario Correo & TikTok    & $-71.4$ & $+26.8$ & 98.3 \\
        José Luna Gálvez       & RPP           & TikTok    & $-52.2$ & $+26.8$ & 79.0 \\
        Roberto Sánchez        & Diario Correo & TikTok    & $-65.2$ & $+2.9$  & 68.1 \\
        Alfonso López Chau     & Diario Correo & TikTok    & $-45.9$ & $+19.0$ & 64.9 \\
        Yonhy Lescano          & TikTok        & Twitter/X & $+25.0$ & $-35.9$ & 60.9 \\
        José Luna Gálvez       & Diario Correo & Twitter/X & $-71.4$ & $-12.2$ & 59.2 \\
        Alfonso López Chau     & TikTok        & Twitter/X & $+19.0$ & $-39.7$ & 58.7 \\
        José Luna Gálvez       & TikTok        & YouTube   & $+26.8$ & $-31.4$ & 58.2 \\
        Keiko Fujimori         & Diario Correo & El Comercio & $-47.8$ & $+8.7$ & 56.5 \\
        Carlos Espá            & TikTok        & Twitter/X & $+57.7$ & $+2.0$  & 55.7 \\
        Álvaro Paz de la Barra & TikTok        & Twitter/X & $+30.0$ & $-25.3$ & 55.3 \\
        Rafael López Aliaga    & Diario Correo & TikTok    & $-60.9$ & $-6.5$  & 54.3 \\
        Keiko Fujimori         & El Comercio   & Twitter/X & $+8.7$  & $-45.0$ & 53.7 \\
        Yonhy Lescano          & TikTok        & YouTube   & $+25.0$ & $-26.9$ & 51.9 \\
        \specialrule{.05em}{.03em}{.03em}
        Mario Vizcarra         & TikTok        & Twitter/X & $+21.9$ & $-25.0$ & 46.9 \\
        Ronald Atencio         & TikTok        & Twitter/X & $+25.8$ & $-19.4$ & 45.2 \\
        Roberto Chiabra        & TikTok        & YouTube   & $+66.7$ & $+21.7$ & 44.9 \\
        Rafael López Aliaga    & TikTok        & Twitter/X & $-6.5$  & $-50.0$ & 43.5 \\
        Keiko Fujimori         & El Comercio   & RPP       & $+8.7$  & $-34.5$ & 43.2 \\
        Rafael López Aliaga    & Diario Correo & YouTube   & $-60.9$ & $-19.4$ & 41.5 \\
        \specialrule{.1em}{.05em}{.05em}
    \end{tabular}
    \begin{flushleft}
        \small Fuente: Elaboración propia. La línea intermedia separa los 14 pares con $\text{IDN} > 50$ (de 98.3 a 51.9).
    \end{flushleft}
\end{table}

El contraste del IDN revela que la divergencia no se distribuye de forma azarosa, sino que adopta una \textbf{estructura bimodal}: las fuentes se agrupan en dos polos valorativos opuestos en lugar de dispersarse de manera continua alrededor de un valor central. De los 20 pares reportados, \textbf{14 superan el umbral $\text{IDN} > 50$} (desde 98.3 hasta 51.9). El patrón es además sistemático: en \textbf{8 de los 10 pares más divergentes}, uno de los polos es TikTok —con sentimiento agregado positivo— y el otro es prensa tradicional (Diario Correo, RPP) o Twitter/X —con sentimiento agregado negativo—. El caso extremo es \textbf{José Luna Gálvez}, cuyo contenido en Diario Correo arroja un ISN de $-71.4$ frente a $+26.8$ en TikTok, una divergencia casi total ($\text{IDN} = 98.3$). Esta concentración de los pares en dos polos opuestos es la evidencia estructural que distingue la polarización de la percepción mediática digital de una simple variabilidad estadística entre fuentes: el ICMC aporta la magnitud agregada y el IDN, junto con el patrón sistemático descrito, aporta la estructura de dos polos.

De forma complementaria, los índices de agenda confirman la coherencia del corpus con el calendario electoral. El Índice de Relevancia Temática (IRT), acotado al universo de documentos que mencionan candidatos, sitúa a la cabeza de la agenda los \textbf{debates presidenciales} (\textit{debate\_presidencial\_jne}, 2.92\%; \textit{debate\_presidencial\_seguridad}, 2.43\%) y las \textbf{encuestas de intención de voto} (Ipsos y Datum, 1.07\% cada una). El Índice de Velocidad de Emergencia (IVE) registra sus mayores picos en eventos verificables del período: los cuestionamientos a José Jerí en la presidencia ($+60.0$, 15 de febrero), la improcedencia de candidaturas resuelta por el JNE ($+56.3$, 17 de enero) y el caso cócteles de Keiko Fujimori ($+26.7$, 14 de enero). La coincidencia de estos picos con hechos políticos documentados valida que la métrica detecta correctamente la irrupción súbita de un tema en la agenda electoral, honrando su declaración como indicadores complementarios del núcleo analítico.

\noindent \textbf{Dictamen de Validación:} La evidencia empírica confirma las dos condiciones verificables declaradas en HE3: el ICMC supera el umbral de 25 en \textbf{5 candidatos} (José Luna Gálvez, Alex Gonzáles, Roberto Sánchez, Yonhy Lescano y Keiko Fujimori) y el IDN supera el umbral de 50 en \textbf{14 pares fuente-candidato}, con un caso extremo de 98.3 (José Luna Gálvez, Diario Correo frente a TikTok). En consecuencia, \textbf{se acepta formalmente la Hipótesis Específica 3 (HE3)}, quedando detectada y cuantificada la polarización de la percepción mediática digital sobre un subconjunto relevante de candidatos presidenciales del ecosistema digital electoral peruano.
