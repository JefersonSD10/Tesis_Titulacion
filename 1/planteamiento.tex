...
El uso integrado de modelos de lenguaje de gran escala (LLMs) y grafos de conocimiento permite construir un sistema de inteligencia electoral capaz de realizar análisis contextual, estructural y relacional del discurso mediático digital, mejorando la identificación de sentimientos dirigidos, tópicos semánticos y relaciones entre actores políticos en entornos digitales.}
\HipotesisGeneral
