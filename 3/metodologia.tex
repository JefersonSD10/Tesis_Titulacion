...
\begin{tabular}{lcrr}
\specialrule{.1em}{.05em}{.05em}
\multicolumn{1}{c}{Ítem} & \multicolumn{1}{c}{Tiempo (horas)} & \multicolumn{1}{c}{Costo (soles)} & \multicolumn{1}{c}{Subtotal} \
\specialrule{.1em}{.05em}{.05em}
\multicolumn{4}{l}{Recursos materiales} \
Equipo de cómputo para desarrollo (GPU integrada) & & S/.4,800.00 & S/.4,800.00 \
\hline
\multicolumn{4}{l}{Gestiones académicas} \
Matrícula en cursos de actualización y TSP & & S/.8500.00 & S/.8500.00 \
\hline
...
\begin{table}[h!]
\caption[Presupuesto de herramientas y servicios en la nube]{Detalle del presupuesto correspondiente a herramientas y servicios en la nube empleados en el desarrollo del proyecto.}
\label{4:table10}
\centering
\small
\begin{tabular}{lcrcr}
\specialrule{.1em}{.05em}{.05em}
\multicolumn{1}{c}{Ítem} & \multicolumn{1}{c}{Unidades} & \multicolumn{1}{c}{Costo (USD)} & \multicolumn{1}{c}{Horas} & \multicolumn{1}{c}{Subtotal} \
\specialrule{.1em}{.05em}{.05em}
\multicolumn{4}{l}{Google Cloud Platform (GCP)} & -- \
Máquina virtual para scraping (e2-medium, 4 GB RAM) & 1 & $0.034 & 400 & $13.60 \
Cloud Run para ejecución del pipeline en tiempo real & 1 & $0.024 & 300 & $7.20 \
Cloud Storage para la capa Bronze & 1 & $0.020 & -- & $8.00 \
BigQuery para las capas Silver/Gold & 1 & $5.00 & -- & $15.00 \
\hline
\multicolumn{4}{l}{API de modelos LLM} & -- \
Gemini Flash API (tokens de análisis) & -- & $0.075/1M & -- & $45.00 \
OpenAI GPT-4o API (validación) & -- & $5.00/1M & -- & $25.00 \
\hline
\multicolumn{4}{l}{Neo4j AuraDB (base de datos de grafos)} & -- \
Plan Professional (1 instancia) & 3 & $65.00 & -- & $195.00 \
\hline
\multicolumn{4}{l}{API de X/Twitter} & -- \
