...
LLM a moderar el sentimiento negativo. La extracción de \textbf{actores principales} consolidó un F1 micro de 0.825, demostrando que el LLM recupera eficazmente tanto los actores nombrados de forma explícita como aquellos implícitos por el contexto de la noticia, superando los retos iniciales de la tarea.
...
\begin{table}[h!]
    ...
    \begin{tabular}{ m{4.8cm}M{2.2cm}M{2.2cm}M{2.2cm} }
        ...
        \specialrule{.05em}{.05em}{.05em}
        Deduplicación de temas (n=150)              & 0.850 & 0.830          & \textbf{0.840} \\
        \specialrule{.1em}{.05em}{.05em}
    \end{tabular}
    \begin{flushleft}
        \small Fuente: Elaboración propia.
...
\noindent \textbf{Nota metodológica sobre el tamaño muestral:} Debido a la alta complejidad cognitiva requerida para la anotación manual de alineación temática multi-fuente en un contexto electoral dinámico, la presente evaluación de consistencia temática ($n=15$) se estructuró bajo un enfoque de \textit{Prueba Piloto de Viabilidad Técnica} (Proof of Concept). Si bien este tamaño acota la generalización estadística general del módulo, permite validar de forma controlada la consistencia algorítmica inicial del pipeline de grafos de conocimiento antes de su escalamiento operativo a nivel de producción.
