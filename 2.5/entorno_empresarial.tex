% ══════════════════════════════════════════════════════════════
% CAPÍTULO III — ENTORNO ORGANIZACIONAL
...
\chapter{Entorno Organizacional}

\noindent\textit{Nota metodológica.} El presente capítulo describe el entorno institucional en el que se inscribe el sistema de inteligencia electoral propuesto. Dado que la entidad de aplicación es el Jurado Nacional de Elecciones (JNE) —organismo constitucional autónomo del Estado peruano, de naturaleza pública y no lucrativa—, las herramientas de análisis estratégico (Modelo Canvas, matrices EFI/EFE y FODA cuantitativo) se utilizan de manera adaptada: las dimensiones de mercado, costos y propuesta de valor se reinterpretan en clave de servicio público, sostenibilidad institucional y valor analítico para el ecosistema electoral. Esta adaptación permite preservar el rigor del análisis estratégico sin asumir una lógica empresarial-lucrativa ajena a la naturaleza del JNE.

% ─────────────────────────────────────────────────────────────
\section{Descripción de la organización}
% ─────────────────────────────────────────────────────────────

\subsection{Reseña histórica y actividad institucional}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.8cm} p{3.2cm} p{4.2cm} p{4.5cm}}
        ...
        XLSX descargados desde el portal estadístico del BCRP (\url{https://estadisticas.bcrp.gob.pe/estadisticas/series/}) &
...
% ─────────────────────────────────────────────────────────────
\section{Datos generales estratégicos del sistema propuesto}
% ─────────────────────────────────────────────────────────────

\subsection{Visión, misión y valores o principios}

\noindent Dado que el sistema de inteligencia electoral propuesto está concebido para incorporarse en el contexto institucional del Jurado Nacional de Elecciones (JNE) —entidad descrita en la sección~3.1—, la visión y la misión que se adoptan como referentes estratégicos son las que la propia institución declara en sus documentos de gestión vigentes \parencite{ent_jne2023institucional}. El sistema se diseña, por tanto, como un instrumento orientado a apoyar dicha visión y misión institucional.

\subsubsection*{Visión institucional del JNE}

«Personas que viven, ejercen y defienden la democracia, en una sociedad solidaria, sin exclusión y con desarrollo sostenible.» \parencite{ent_jne2023institucional}

\subsubsection*{Misión institucional del JNE}

«Impartir justicia y formar liderazgos políticos al servicio del fortalecimiento de la democracia.» \parencite{ent_jne2023institucional}

\subsubsection*{Valores y principios de diseño del sistema}
